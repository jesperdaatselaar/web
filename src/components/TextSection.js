    ...
    <section className="section">
      <div className="content">
        <p>
          ...
          around, I bought my first camera: A Sony Alpha A6100. Since then I
          have been capturing a lot of moments in different Dutch and some
          European cities. Now, with the addition of a drone, a DJI Mini 2 to be
          specific, I will capture even more and more.
        </p>
      </div>
    </section>
  );
